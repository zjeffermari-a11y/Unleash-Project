    ...
    <section id="gallery" className="py-32 bg-[#050505] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="text-5xl md:text-7xl font-display font-bold text-white mb-16 tracking-tight leading-[1.1]"
        >
        ...
        <form onSubmit={handleSearch}>
          ...
          >
            ...
            <input 
              ...
              className="w-full bg-transparent border-none outline-none text-white px-4 py-3 placeholder-gray-400"
            />
            <motion.button 
        ...
        <div className="mt-24 flex justify-center items-center gap-12 md:gap-32">
          <Link to="/gallery">
            <motion.div whileHover={{ scale: 1.1, y: -5 }} className="flex flex-col items-center gap-4 cursor-pointer group">
              ...
              <span className="text-white font-medium tracking-widest uppercase text-sm group-hover:text-amber-400 transition-colors duration-300">Local</span>
            </motion.div>
          </Link>
          ...
          <Link to="/gallery">
            <motion.div whileHover={{ scale: 1.1, y: -5 }} className="flex flex-col items-center gap-4 cursor-pointer group">
              ...
              <span className="text-white font-medium tracking-widest uppercase text-sm group-hover:text-red-400 transition-colors duration-300">Global</span>
            </motion.div>
          </Link>
        </div>
      </div>
